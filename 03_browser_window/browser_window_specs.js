...
describe('BrowserWindow', () => {
  ...
  it('the BrowserWindow function adds a default tab if the tabs argument is omitted', () => {
  ...
  it('has a joinWindows method on its prototype that merges the argument window into the Window object the method is called on', () => {
  ...
  it('has a closeTab method that accepts an index position and removes (closes) the tab at that index position', () => {
    ...
    // If you close all the tabs, the default tab will re-open, this is why the "defaultHomepage.com" tab
    // is the only tab open.
